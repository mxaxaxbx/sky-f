    ...
    >
      ...
      >
        ...
        >
          ...
          <button
            @click="emitAction('copy-link')"
            class="menu-btn"
          >
            <img
              src="/icon/icon-link.svg"
              alt="link"
              class="menu-icon -rotate-45"
            />
      ...
      >
        ...
        >
          <button
            @click="emitAction('rename-folder')"
            class="menu-btn"
          >
            <img
              src="/icon/icon-edit.svg"
      ...
      <template v-else>
        ...
        >
          ...
          <button
            @click="emitAction('create-folder')"
            class="menu-btn"
          >
            <img
              src="/icon/icon-new-folder.svg"
              alt="new folder"
              class="menu-icon h-6 mr-4"
            />
        ...
        >
          ...
          >
            ...
            <g mask="url(#mask_ctx_delete)">
              <path
                d="M12 2C14.4189 2 16.4361 3.71782 16.8994 6H22V8H20V17C20 19.7614 17.7614 22 15 22H9C6.23858 22 4 19.7614 4 17V8H2V6H7.10059C7.5639 3.71782 9.58108 2 12 2ZM6 17C6 18.6569 7.34315 20 9 20H15C16.6569 20 18 18.6569 18 17V8H6V17ZM11 18H9V10H11V18ZM15 18H13V10H15V18ZM12 4C10.6941 4 9.58594 4.83532 9.17383 6H14.8262C14.4141 4.83532 13.3059 4 12 4Z"
...
const adjustedX = computed(() => {
  const overflowRight = props.x + menuWidth > window.innerWidth;
...
const adjustedY = computed(() => {
  const overflowBottom = props.y + menuHeight > window.innerHeight;
