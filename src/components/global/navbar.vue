    ...
    <div class="relative flex items-center justify-between h-full">
      ...
      <Dropdown v-if="isAuth"
        :classes="[
          ...
          'absolute', 'z-20',
          'sm:top-6', '-top-1.5',
          '-right-2', 'w-[calc(100vw-0.25rem)]', 'h-[calc(100vh-0.22rem)]', 'py-16 sm:h-auto sm:w-80 sm:py-8',
        ]"
      >
        ...
        <template #content="{ }">
          <div class="flex flex-col w-full h-full items-center justify-center">
            ...
            <div class="flex flex-col items-center mx-8 mb-6">
              <!-- community -->
              <h1 class="text-xs font-regular ml-5 sm:ml-4 text-[var(--text-terceary)] mb-2 self-start
                  ">Community
              </h1>
            ...
            class="
              flex justify-around
              mt-10 px-16 space-x-4
              text-[10px] text-[var(--text-terceary)]
              opacity-30
